...
const DECLARACAO = "Clarice, quem dirira que estaríamos juntos. Bom, na verdade, todos diziam. 🤣 \n Talvez a gente era tchongo de mais para enxergar isso, de toda forma, talvez foi melhor assim.\n  Eu só tenho a agradecer a Deus pela oportunidade de cada dia me tornar um homem melhor e te fazer feliz da melhor maneira.\n Dentre todas as minhas orações uma delas é a permisão de Deus de poder envelhecer ao seu lado. Você é o tipo de pessoa que me cativa sabe? Inteligente, simpática e com uma visão de mundo incrivelmente autêntica. Todos esses detalhes, cada olhar, cada gesto, me faz ficar perdidamente cativado e talvez se perder seja o melhor caminho. Se por dentro você é maginífica o exterior não poderia ser diferente. Você é toda linda meu amor, em você não há defeito algum. Seus olhos, seu sorriso, seu cabelo e cada curva do seu corpo são uma como um evento cósmico e , de certo, as estrelas aplaudiriam.       "; // ← EDITE AQUI
